...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void KinematicsIntraFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void KinematicsIntraFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void KinematicsIntraFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
//  EVT_BUTTON( ID_LAYOUT,         KinematicsIntraFrame::OnLayout        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    KinematicsIntraFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    KinematicsIntraFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, KinematicsIntraFrame::OnOverwriteScreen )
