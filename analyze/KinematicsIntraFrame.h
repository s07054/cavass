...
//======================================================================
/**
 * \file   KinematicsIntraFrame.h
 * \brief  KinematicsIntraFrame definition.
 ...
 */
//======================================================================
#ifndef __KinematicsIntraFrame_h
#define __KinematicsIntraFrame_h
...
#include  "KinematicsIntraCanvas.h"
...
/** \brief KinematicsIntraFrame class definition.
 *
 *  a frame with an overlay of two data sets.
 */
class KinematicsIntraFrame : public MainFrame 
{
...
//    wxSlider*      m_width;             ///< contrast width slider
  protected:
    ...
    wxFlexGridSizer*  fgs;
    wxButton*      m_KinematicsIntraTypeBut;
  ...
  //wxTextCtrl*    mSigmaText;
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  public:
    KinematicsIntraFrame ();
    ~KinematicsIntraFrame ( void );
    ...
    void OnKinematicsIntraSave             (wxCommandEvent& e );    
 ...
 //   void OnZoomOut      ( wxCommandEvent& e );
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS( KinematicsIntraFrame )
    DECLARE_EVENT_TABLE()
};
