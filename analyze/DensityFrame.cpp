...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void DensityFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void DensityFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void DensityFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
//  EVT_BUTTON( ID_LAYOUT,         DensityFrame::OnLayout        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    DensityFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    DensityFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, DensityFrame::OnOverwriteScreen )
