...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ROIStatisticalFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ROIStatisticalFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ROIStatisticalFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
//  EVT_BUTTON( ID_LAYOUT,         ROIStatisticalFrame::OnLayout        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    ROIStatisticalFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    ROIStatisticalFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, ROIStatisticalFrame::OnOverwriteScreen )
