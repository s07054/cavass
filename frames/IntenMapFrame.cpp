...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void IntenMapFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void IntenMapFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void IntenMapFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
BEGIN_EVENT_TABLE       ( IntenMapFrame, wxFrame )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    IntenMapFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    IntenMapFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, IntenMapFrame::OnOverwriteScreen )
