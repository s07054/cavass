...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ToStructureFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ToStructureFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void ToStructureFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
//  EVT_BUTTON( ID_LAYOUT,         ToStructureFrame::OnLayout        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    ToStructureFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    ToStructureFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, ToStructureFrame::OnOverwriteScreen )
