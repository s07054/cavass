...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AlgebraFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AlgebraFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AlgebraFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
BEGIN_EVENT_TABLE       ( AlgebraFrame, wxFrame )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    AlgebraFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    AlgebraFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, AlgebraFrame::OnOverwriteScreen )
