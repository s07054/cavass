...
void RegisterFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}

void RegisterFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
void RegisterFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
BEGIN_EVENT_TABLE       ( RegisterFrame, wxFrame )
 ...
 /* EVT_MENU( ID_ABOUT,          MainFrame::OnAbout           )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    RegisterFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    RegisterFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, RegisterFrame::OnOverwriteScreen )
