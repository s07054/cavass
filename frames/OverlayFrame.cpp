...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#if 0
void OverlayFrame::OnSaveScreen ( wxCommandEvent& e ) {
...
void OverlayFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}

void OverlayFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
void OverlayFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
