 ...
 */
void ExportFrame::OnAppendScreen ( wxCommandEvent& unused ) {
 ...
 *  \todo  this needs to be implemented.
 */
void ExportFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
void ExportFrame::OnSeriesUID( wxCommandEvent& unused )
{
	...
	if (mSeriesUID == wxEmptyString)
		mSeriesUID = wxString::Format("1.2.276.0.7230010.3.1.4.%d.%d",
			getpid(), time(NULL));
