...
//======================================================================
/**
 * \file   VOIStandardlizeFrame.h
 * \brief  VOIStandardlizeFrame definition.
 ...
 */
//======================================================================
#ifndef __VOIStandardlizeFrame_h
#define __VOIStandardlizeFrame_h
...
/** \brief VOIStandardlizeFrame class definition.
 *
 *  a frame with an overlay of two data sets.
 */
class VOIStandardlizeFrame : public MainFrame 
{
  ...
  SetLowHighControls*        mSetLowHighControls;      
  wxComboBox*               mModeType;
  wxButton*                 msetParaFileB;
  wxButton*                 mLowHighB;
  wxComboBox*               mTrainMethodCB;
...
public:
    ...
    enum {
        ...
        ID_INVERT1,         ID_SET_LOWILE,       ID_SET_HIGHILE,
        ID_SLICE1_SLIDER,    ID_SET_PARAFILE, ID_LOWHIGN, ID_TRAINMETHOD,
        ID_SCALE1_SLIDER,  ID_MODETYPE, 
        ID_OVERLAY, ID_BUSY_TIMER,
        ID_OVERWRITE_SCREEN, ID_APPEND_SCREEN, ID_BROWSE_SCREEN, ID_CHECKBOX_LAYOUT,
        ID_LAYOUT, ID_VOIStandardlize_ROI, ID_VOIStandardlize_GRAD, ID_SAVE
    };
    enum {
  ...
  enum           {TypeNumber = 20};
  wxString       VOIStandardlizeName[TypeNumber];
  wxArrayString  mTrainFileNames;
  wxString           mParaFileName;
...
//    wxSlider*      m_width;             ///< contrast width slider
  protected:
    ...
    wxFlexGridSizer*  fgs;
    wxButton*      m_VOIStandardlizeTypeBut;	
  ...
  //wxTextCtrl*    mSigmaText;
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  public:
    VOIStandardlizeFrame ();
    ~VOIStandardlizeFrame ( void );
	...
	void OnModeType ( wxCommandEvent& e );
	void OnSetParaFileName ( wxCommandEvent& e );	

	void OnSetLowHighIle ( wxCommandEvent& e );
	void OnSetLowPctile ( wxCommandEvent& e );
	void OnSetHighPctile ( wxCommandEvent& e );
...
//    void OnLayout                 ( wxCommandEvent& e );
	//void OnVOIStandardlizeGrad             (wxCommandEvent& e );
 //   void OnVOIStandardlizeROI             (wxCommandEvent& e );
    void OnVOIStandardlizeSave             (wxCommandEvent& e );    
 ...
 //   void OnZoomOut      ( wxCommandEvent& e );
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    DECLARE_DYNAMIC_CLASS( VOIStandardlizeFrame )
    DECLARE_EVENT_TABLE()
};
