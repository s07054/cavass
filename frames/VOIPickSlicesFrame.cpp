...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIPickSlicesFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIPickSlicesFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIPickSlicesFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
BEGIN_EVENT_TABLE       ( VOIPickSlicesFrame, wxFrame )
 ...
 EVT_BUTTON( ID_CINE,           VOIPickSlicesFrame::OnCine        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    VOIPickSlicesFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    VOIPickSlicesFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, VOIPickSlicesFrame::OnOverwriteScreen )
