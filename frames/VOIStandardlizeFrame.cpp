...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIStandardlizeFrame::OnAppendScreen ( wxCommandEvent& unused ) {
    wxString  s = wxString::Format( "append screen to file %s",
        (const char *)mSaveScreenControls->getFileName().c_str() );
    SetStatusText( s,  0 );
}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIStandardlizeFrame::OnBrowseScreen ( wxCommandEvent& unused ) {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void VOIStandardlizeFrame::OnOverwriteScreen ( wxCommandEvent& unused ) {
...
BEGIN_EVENT_TABLE       ( VOIStandardlizeFrame, wxFrame )
 ...
 EVT_BUTTON( ID_CINE,           VOIStandardlizeFrame::OnCine        )
  ...
  EVT_BUTTON( ID_APPEND_SCREEN,    VOIStandardlizeFrame::OnAppendScreen    )
  EVT_BUTTON( ID_BROWSE_SCREEN,    VOIStandardlizeFrame::OnBrowseScreen    )
  EVT_BUTTON( ID_OVERWRITE_SCREEN, VOIStandardlizeFrame::OnOverwriteScreen )
