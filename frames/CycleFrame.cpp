...
void CycleFrame::addButtonBox ( void ) {
    ...
    //row 3, col 2
    wxButton*  erase = new wxButton( mControlPanel, ID_ERASE, "Erase", wxDefaultPosition, wxSize(buttonWidth,buttonHeight) );
    ::setColor( erase );
    fgs->Add( erase, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0 );
#endif
    //row 4, col 1
...
#if 0
    //row 8, col 1
    mMeasureCheck = new wxCheckBox( mControlPanel, ID_MEASURE, "measure" );
    mMeasureCheck->SetValue( 0 );
    fgs->Add( mMeasureCheck, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0 );
    ::setColor( mMeasureCheck );
    //mMeasure = false;
    //row 8, col 2
    mLockCheck = new wxCheckBox( mControlPanel, ID_LOCK, "lock" );
    mLockCheck->SetValue( 0 );
    fgs->Add( mLockCheck, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0 );
    ::setColor( mLockCheck );
    //mLock = false;
#endif
#if 0
    //row 9, col 1
    mMotionCheck = new wxCheckBox( mControlPanel, ID_MOTION, "1-way motion" );
    mMotionCheck->SetValue( 0 );
    fgs->Add( mMotionCheck, 0, wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0 );
    ::setColor( mMotionCheck );
#endif
#if 0
